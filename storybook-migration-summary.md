...
- `npx storybook@latest automigrate --config-dir apps/bbl-nextjs/.storybook --renderer undefined`

- `npx storybook@latest automigrate --config-dir libs/features/.storybook --renderer undefined`

- `npx storybook@latest automigrate --config-dir libs/ui-components/.storybook --renderer undefined`
